...
public:
    ...
    ChatCommand* GetCommands() const
    {
        static ChatCommand guildCommandTable[] =
        {
            ...
            { "givexp",         SEC_ADMINISTRATOR,  true,  &HandleGuildGiveXP,                  "", NULL },
    ...
    static bool HandleGuildGiveXP(ChatHandler* handler, char const* args)
    {
        uint32 const xp = atol(args);
