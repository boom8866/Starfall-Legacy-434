...
class npc_frostlord_ahune : public CreatureScript
{
    public:
        ...
        {
            npc_frostlord_ahuneAI(Creature* creature) : ScriptedAI(creature), _summons(me)
            {
            }
            ...
            {
                if (GameObject* chest = me->SummonGameObject(GO_ICE_CHEST, -97.095f, -203.866f, -1.191f, 1.5f, 0, 0, 0, 0, 0))
