...
public:
    ...
    struct npc_eye_of_acherusAI : public VehicleAI
    {
        npc_eye_of_acherusAI(Creature* creature) : VehicleAI(creature){}
        ...
        void Reset()
        {
            ...
            // Text is not good because you're not really near to Eye of Acherus
        ...
        void JustDied(Unit* /*killer*/)
        {
            if (Unit* charmer = me->GetCharmer())
            {
               ...
               charmer->RemoveAurasDueToSpell(SPELL_EYE_FL_BOOST_FLY);
               charmer->RemoveAurasDueToSpell(SPELL_EYE_VISUAL);
               charmer->RemoveAurasDueToSpell(SPELL_EYE_FL_BOOST_RUN);
            }
        }
        ...
        struct npc_scarlet_miner_cartAI : public PassiveAI
        {
            ...
            void PassengerBoarded(Unit* who, int8 /*seatId*/, bool apply)
            {
                if (apply)
                {
                    ...
                    who->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE);
                }
                else
                {
