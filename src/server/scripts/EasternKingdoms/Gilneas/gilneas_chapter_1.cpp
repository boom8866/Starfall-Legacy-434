...
public:
    ...
    bool OnQuestReward(Player* player, Creature* creature, Quest const* quest, uint32 /*item*/)
    {
        if (quest->GetQuestId() == 14222)
        {
            ...
            player->RemoveAurasDueToSpell(72872);
    ...
    struct npc_bloodfang_stalker_c1AI : public ScriptedAI
    {
        ...
        void SpellHit(Unit* caster, const SpellInfo* spell)
        {
            ...
            if (spell->Id == SPELL_THROW_TORCH)
            {
                ...
                if(horse && me->getVictim()->GetTypeId() == TYPEID_PLAYER)//We should ONLY switch our victim if we currently have the player targeted
                {
