...
char serviceLongName[] = "StarfallCore world server";
char serviceDescription[] = "Server software for a 4.3.4 Realm";
/*
...
extern int main(int argc, char **argv)
{
    ...
    // 2 - restart command used, this code can be used by restarter for restart Trinityd
     ...
     #if PLATFORM != PLATFORM_WINDOWS
    *((uint32 volatile*)NULL) = 0; // gdb doesn't like shutdowns, it loves crashes tho
    #endif
    return ret;
}
