...
class MySQL
{
    public:
        ...
        */
        ...
        {
            mysql_thread_init();
            sLog->outWarn(LOG_FILTER_SQL, "Core thread with ID [ %lu ] initializing MySQL thread.",
        ...
        */
        ...
        {
            mysql_thread_end();
            sLog->outWarn(LOG_FILTER_SQL, "Core thread with ID [ %lu ] shutting down MySQL thread.",
                (uint64)ACE_Based::Thread::currentId());
        }
