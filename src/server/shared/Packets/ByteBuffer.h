...
class ByteBufferPositionException : public ByteBufferException
{
    ...
    protected:
        void PrintError() const
        {
            ...
            sLog->outError(LOG_FILTER_NETWORKIO, "Attempted to %s value with size: %lu in ByteBuffer (pos: %lu size: %lu )\n[Stack trace: %s]",
...
class ByteBufferSourceException : public ByteBufferException
{
    ...
    protected:
        void PrintError() const
        {
            ...
            sLog->outError(LOG_FILTER_NETWORKIO, "Attempted to put a %s in ByteBuffer (pos: %lu size: %lu )\n[Stack trace: %s]",
