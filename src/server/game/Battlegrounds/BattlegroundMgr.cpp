    ...
    for (Battleground::BattlegroundScoreMap::const_iterator itr = bg->GetPlayerScoresBegin(); itr != bg->GetPlayerScoresEnd(); ++itr)
    {
        ...
        if (Player* player = ObjectAccessor::FindPlayer(itr->first))
       {
        ...
        else
        {
            ...
            {
                sLog->outError(LOG_FILTER_BATTLEGROUND, "Player " UI64FMTD " has scoreboard entry for battleground %u but do not have battleground data!", itr->first, bg->GetTypeID(true));
                continue;
            }
...
Battleground* BattlegroundMgr::CreateNewBattleground(BattlegroundTypeId originalBgTypeId, PvPDifficultyEntry const* bracketEntry, uint8 arenaType, bool isRated)
{
    ...
    {
        BattlegroundTypeId ratedbgs[5];

        ratedbgs[0] = BATTLEGROUND_WS;
        ratedbgs[1] = BATTLEGROUND_AB;
        ratedbgs[2] = BATTLEGROUND_BFG;
        ratedbgs[3] = BATTLEGROUND_TP;
        ratedbgs[4] = BATTLEGROUND_EY;

        bgTypeId = ratedbgs[urand(0, 4)];
    }
...
void BattlegroundMgr::CreateInitialBattlegrounds()
{
    ...
    do
    {
        ...
        else if (data.bgTypeId != BATTLEGROUND_RB && data.bgTypeId != BATTLEGROUND_RATED_10_VS_10 && data.bgTypeId != BATTLEGROUND_RATED_15_VS_15 && data.bgTypeId != BATTLEGROUND_RATED_25_VS_25)
...
void BattlegroundMgr::BuildBattlegroundListPacket(WorldPacket* data, uint64 guid, Player* player, BattlegroundTypeId bgTypeId)
{
    ...
    uint32 winnerConquest = (player->GetRandomWinner() ? BG_REWARD_WINNER_CONQUEST_FIRST : BG_REWARD_WINNER_CONQUEST_LAST);
    uint32 winnerHonor = (player->GetRandomWinner() ? BG_REWARD_WINNER_HONOR_FIRST : BG_REWARD_WINNER_HONOR_LAST);
    uint32 loserHonor = (!player->GetRandomWinner() ? BG_REWARD_LOSER_HONOR_FIRST : BG_REWARD_LOSER_HONOR_LAST);
...
BattlegroundQueueTypeId BattlegroundMgr::BGQueueTypeId(BattlegroundTypeId bgTypeId, uint8 arenaType)
{
    switch (bgTypeId)
    {
        ...
        case BATTLEGROUND_RATED_10_VS_10:
            return BATTLEGROUND_QUEUE_RBG_10v10;
        case BATTLEGROUND_RATED_15_VS_15:
            return BATTLEGROUND_QUEUE_RBG_15v15;
        case BATTLEGROUND_RATED_25_VS_25:
            return BATTLEGROUND_QUEUE_RBG_25v25;
        case BATTLEGROUND_AA:
        case BATTLEGROUND_BE:
        case BATTLEGROUND_DS:
        case BATTLEGROUND_NA:
...
BattlegroundTypeId BattlegroundMgr::BGTemplateId(BattlegroundQueueTypeId bgQueueTypeId)
{
    switch (bgQueueTypeId)
    {
        ...
        case BATTLEGROUND_QUEUE_RBG_10v10:
            return BATTLEGROUND_RATED_10_VS_10;
        case BATTLEGROUND_QUEUE_RBG_15v15:
            return BATTLEGROUND_RATED_15_VS_15;
        case BATTLEGROUND_QUEUE_RBG_25v25:
...
BattlegroundTypeId BattlegroundMgr::GetRandomBG(BattlegroundTypeId bgTypeId)
{
    ...
    else if (bgTypeId == BATTLEGROUND_RB || bgTypeId == BATTLEGROUND_RATED_10_VS_10 || bgTypeId == BATTLEGROUND_RATED_15_VS_15 || bgTypeId == BATTLEGROUND_RATED_25_VS_25)
    {
