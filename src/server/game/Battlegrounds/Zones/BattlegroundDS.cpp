...
bool BattlegroundDS::SetupBattleground()
{
    ...
    // buffs
        || !AddObject(BG_DS_OBJECT_BUFF_1, BG_DS_OBJECT_TYPE_BUFF_1, 1318.7f, 763.845f, 3.15975f, 2.36013f, 0, 0, 0.730314f, -0.683111f, 120)
        || !AddObject(BG_DS_OBJECT_BUFF_2, BG_DS_OBJECT_TYPE_BUFF_2, 1264.7f, 817.848f, 3.15967f, 5.48601f, 0, 0, 0.700409f, 0.713742f, 120)
    // knockback creatures
