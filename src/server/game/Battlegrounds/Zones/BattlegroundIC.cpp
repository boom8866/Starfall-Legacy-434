...
Transport* BattlegroundIC::CreateTransport(uint32 goEntry, uint32 period)
{
    ...
    if (!t->Create(sObjectMgr->GenerateLowGuid(HIGHGUID_MO_TRANSPORT), goEntry, PHASEMASK_ANYWHERE, mapid, x, y, z, o, 255, 0))
    {
        delete t;
        return NULL;
    }
