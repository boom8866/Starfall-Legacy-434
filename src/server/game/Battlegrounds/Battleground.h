...
class Battleground
{
    public:
        ...
        void AddSpectator(uint32 playerId) {
            m_Spectators.insert(playerId);
        }
        void RemoveSpectator(uint32 playerId) {
            m_Spectators.erase(playerId);
        }
        bool HaveSpectators() {
            return (m_Spectators.size() > 0);
        }
