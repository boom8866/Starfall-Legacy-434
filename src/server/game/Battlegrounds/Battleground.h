...
{
    BG_REWARD_WINNER_HONOR_FIRST    = 15000,
    BG_REWARD_WINNER_CONQUEST_FIRST = 2500,
    BG_REWARD_WINNER_HONOR_LAST     = 10000,
    BG_REWARD_WINNER_CONQUEST_LAST  = 0,
    BG_REWARD_LOSER_HONOR_FIRST     = 4000,
    BG_REWARD_LOSER_HONOR_LAST      = 3000
};
