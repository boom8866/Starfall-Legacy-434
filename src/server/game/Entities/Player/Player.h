...
enum ActionButtonType
{
    ...
    ACTION_BUTTON_SPECIAL   = ACTION_BUTTON_EQSET | 0x10,
...
enum PlayerFieldByte2Flags
{
    ...
    PLAYER_FIELD_BYTE2_DETECT_AMORE_0    = 0x02, // SPELL_AURA_DETECT_AMORE
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool CanBuyGuildRewardItem(uint32 const itemId);
        bool CanBuyGuildRewardItem(GuildReward const* reward);
        ...
        */
        void ModifyCurrency(uint32 id, int32 count, bool printLog = true, bool ignoreMultipliers = false, bool isRefunded = false);
        ...
        EnchantDurationList const& GetEnchantmentList() const { return m_enchantDuration; }
        ...
        void ModifySpellCooldown(uint32 spell_id, int32 diff);
        ...
        static bool const InvisibilityNeedsDisplayGlow(InvisibilityType const type) { return type == INVISIBILITY_GENERAL || type == INVISIBILITY_DRUNK || type == INVISIBILITY_TRAP; }
        ...
        inline void SurveyDigSite() { archaeology.UseSite(); }
        inline void NotifyRequestResearchHistory() { archaeology.SendResearchHistory(); }
        inline bool ArchProjectCompleteable(uint32 projectId) { return archaeology.ProjectCompleteable(uint16(projectId)); }
        inline bool HasArchProject(uint32 projectId) { return archaeology.ProjectExists(uint16(projectId)); }
        ...
        void RewardGuildReputation(uint32 reputation);
        ...
        bool IsHonorRewardAllowed(Unit* victim) const;
