...
class Transport : public GameObject, public TransportBase
{
    public:
        ...
        bool Create(uint32 guidlow, uint32 entry, uint32 phasemask, uint32 mapid, float x, float y, float z, float ang, uint32 animprogress, uint32 dynflags);
        ...
        uint32 AddNPCPassenger(uint32 tguid, uint32 entry, uint32 phasemask, float x, float y, float z, float o, uint32 anim=0);
