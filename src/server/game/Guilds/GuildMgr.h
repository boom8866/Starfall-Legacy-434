...
public:
    ...
    typedef UNORDERED_MAP<uint32, GuildReward> GuildRewardContainer;
    GuildRewardContainer const& GetGuildRewards() const { return GuildRewards; }
    GuildReward const* GetGuildReward(uint32 const itemid) const;
...
protected:
    ...
    GuildRewardContainer GuildRewards;
};
