...
class ObjectMgr
{
    ...
    public:
        ...
        typedef UNORDERED_MAP<uint32, RewardOnKillEntry> RewOnKillContainer;
        ...
        bool GetPlayerGuildIDByGUID(uint64 guid, uint32 &gguid) const;
        ...
        DungeonEncounterList const* GetDungeonEncounterList(uint32 mapId, Difficulty difficulty)
        {
            ...
            if (itr != _dungeonEncounterStore.end())
                ...
                sLog->outInfo(LOG_FILTER_LFG, "Dungeon encounter list for map %u not found or empty", mapId);
        ...
        bool HasCreatureSpellClickInfo(uint32 const creature_id) const { return _spellClickInfoStore.find(creature_id) != _spellClickInfoStore.end(); }
