...
struct EmotesEntry
{
    ...
    {
        return Flags & (EMOTE_FLAG_READ_ALLOWMOVE | EMOTE_FLAG_READ_ALLOWMOVE_1 |
                        EMOTE_FLAG_READ_ALLOWMOVE_2 | EMOTE_FLAG_READ_ALLOWMOVE_3);
    }
};
...
struct ResearchProjectEntry
{
    ...
    uint32 ProjectSpell; // Spell from Project Found
    uint32 Complexity; // Project Complexity
    char*  Path;
...
struct TalentTabEntry
{
    ...
    uint32  masterySpell[MAX_MASTERY_SPELLS];               // 9-10 passive mastery bonus spells
 };
