...
char const CreatureModelDatafmt[] = "nxxxfxxxxxxxxxffxxxxxxxxxxxxxxx";
...
char const MapEntryfmt[] = "nxiixxsixxixiffxiixi";
...
const std::string CustomSpellEntryfmt = "pppppppppppppppppppppaaaappaapapppppppapppppppppa";
...
char const TransportAnimationEntryfmt[]="diixxxx";
