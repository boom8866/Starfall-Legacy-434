...
void AddSC_blackrock_caverns();              //Blackrock Caverns
...
void AddSC_battle_for_hyjal();               //CoT Battle for Mt. Hyjal
void AddSC_boss_archimonde();
void AddSC_instance_mount_hyjal();
void AddSC_battle_for_hyjal_trash();
...
void AddEasternKingdomsScripts()
{
    ...
    AddSC_blackrock_caverns();              //Blackrock Caverns
...
void AddKalimdorScripts()
{
    ...
    AddSC_battle_for_hyjal();                          //CoT Battle for Mt. Hyjal
    AddSC_boss_archimonde();
    AddSC_instance_mount_hyjal();
    AddSC_battle_for_hyjal_trash();
