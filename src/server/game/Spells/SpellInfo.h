...
enum SpellCustomAttributes
{
    ...
    SPELL_ATTR0_CU_TRIGGERED_BY_CASTER           = 0x00000020,
    ...
    SPELL_ATTR0_CU_IGNORE_OTHER_CASTS            = 0x00040000,
    SPELL_ATTR0_CU_DIMINISH_HEAL                 = 0x00200000,
    SPELL_ATTR0_CU_BINARY                        = 0x10000000,
