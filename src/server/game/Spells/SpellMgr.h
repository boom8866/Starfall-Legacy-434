...
enum SpellFamilyFlag
{
    ...
    // Rogue
    SPELLFAMILYFLAG_ROGUE_VANISH            = 0x00000800,       // Vanish
    ...
    SPELLFAMILYFLAG1_ROGUE_SMOKE_BOMB       = 0x80000000,       // Smoke Bomb

    // Warrior
    SPELLFAMILYFLAG_WARRIOR_CHARGE          = 0x00000001,       // Charge
    SPELLFAMILYFLAG_WARRIOR_SLAM            = 0x00200000,       // Slam
    SPELLFAMILYFLAG_WARRIOR_EXECUTE         = 0x20000000,       // Execute
    SPELLFAMILYFLAG_WARRIOR_CONCUSSION_BLOW = 0x04000000,       // Concussion Blow

    // Warlock
    SPELLFAMILYFLAG_WARLOCK_LIFETAP         = 0x00040000,       // Life Tap

    // Druid
    SPELLFAMILYFLAG2_DRUID_STARFALL         = 0x00000100,       // Starfall

    // Paladin
    SPELLFAMILYFLAG1_PALADIN_DIVINESTORM    = 0x00020000,       // Divine Storm

    // Shaman
    SPELLFAMILYFLAG_SHAMAN_FROST_SHOCK      = 0x80000000,       // Frost Shock
    SPELLFAMILYFLAG_SHAMAN_HEALING_STREAM   = 0x00002000,       // Healing Stream
    SPELLFAMILYFLAG_SHAMAN_MANA_SPRING      = 0x00004000,       // Mana Spring Totem
    SPELLFAMILYFLAG2_SHAMAN_LAVA_LASH       = 0x00000004,       // Lava Lash 
    SPELLFAMILYFLAG_SHAMAN_FIRE_NOVA        = 0x28000000,       // Fire Nova

    // Deathknight
    SPELLFAMILYFLAG_DK_DEATH_STRIKE         = 0x00000010,       // Death Strike
    SPELLFAMILYFLAG_DK_DEATH_COIL           = 0x00002000,       // Death Coil

    // Mage
    SPELLFAMILYFLAG_MAGE_FIRE_BLAST         = 0x00000002,       // Fire Blast
    SPELLFAMILYFLAG_MAGE_FROST_NOVA         = 0x00000040,       // Frost Nova
