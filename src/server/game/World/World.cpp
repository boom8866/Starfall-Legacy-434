...
void World::AddSession_(WorldSession* s)
{
    ...
    s->SendTutorialsData();
    //s->SendSuspendComms(); Change Server Connection ??
...
#   endif
    ...
    m_float_configs[CONFIG_LISTEN_RANGE_SAY]       = ConfigMgr::GetFloatDefault("ListenRange.Say", 80.0f);
    m_float_configs[CONFIG_LISTEN_RANGE_TEXTEMOTE] = ConfigMgr::GetFloatDefault("ListenRange.TextEmote", 80.0f);
    ...
    {
        m_dataPath = dataPath;
        sLog->outInfo(LOG_FILTER_SERVER_LOADING, "Using DataDir %s\n", m_dataPath.c_str());
    }
...
void World::SetInitialWorldSettings()
{
    ...
    sLog->outInfo(LOG_FILTER_SERVER_LOADING, "Loading Archaeology store...");
    ...
    sLog->outInfo(LOG_FILTER_SERVER_LOADING, "Loading Anticheat config...");
