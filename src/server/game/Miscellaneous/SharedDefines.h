...
enum SpellAttr3
{
    ...
    SPELL_ATTR3_DONT_DISPLAY_CHANNEL_BAR         = 0x00002000, // 13
...
enum InvisibilityType
{
    ...
    INVISIBILITY_UNK1       =   1,
    INVISIBILITY_UNK2       =   2,
    INVISIBILITY_TRAP       =   3, // Might be deprecated in 4.3.4
    INVISIBILITY_UNK4       =   4,
    INVISIBILITY_UNK5       =   5,
    INVISIBILITY_DRUNK      =   6,
    INVISIBILITY_UNK7       =   7,
    INVISIBILITY_UNK8       =   8,
    INVISIBILITY_UNK9       =   9, // Quest Invis
    INVISIBILITY_UNK10      =  10,
    INVISIBILITY_UNK11      =  11,
    INVISIBILITY_UNK12      =  12,
    INVISIBILITY_UNK13      =  13, // Quest Invis
    INVISIBILITY_UNK14      =  14, // Quest Invis
    ...
    INVISIBILITY_UNK37      =  37, // Quest invis
...
//RealmSplitState
enum ClientSplitState
{
    CLIENT_SPLIT_STATE_UNINITIALIZED    = -1,
    CLIENT_SPLIT_STATE_NO_CHOICE        = 0,
    CLIENT_SPLIT_STATE_REALM_1          = 1,
    CLIENT_SPLIT_STATE_REALM_2          = 2
};

enum PendingSplitState
{
    PENDING_SPLIT_STATE_UNINITIALIZED   = -1,
    PENDING_SPLIT_STATE_NO_SERVER_SPLIT = 0,
    PENDING_SPLIT_STATE_SPLIT_CHOICE    = 1,
    PENDING_SPLIT_STATE_SPLIT_NO_CHOICE = 2  //pending
};
...
enum BattlegroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_RBG_10v10 = 13,
    BATTLEGROUND_QUEUE_RBG_15v15 = 14,
    BATTLEGROUND_QUEUE_RBG_25v25 = 15,
