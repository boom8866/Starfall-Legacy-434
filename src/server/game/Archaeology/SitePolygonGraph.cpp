/*
 * Copyright (C) 2015 - http://www.wowsoc.org
 *
 * Developer:   Vanzo Luca Samuele <Nephyr Life-Binder>
 * Developer:   Marco Sgura <GLaDOS>
 *
...
SitePolygonGraphNode SitePolygonGraph::randomize_poi()
{
    ...
    SitePolygonGraphArch arch = _arches[i_poi];
