...
(46965,2,0,'Brothers in chaos, the Twilights has come! (Shadows lengthen, endless night.) Deathwind has sundered this world. (Doors once opened never close.) So that its true Lords may return. (The Master comes. He comes He comes.)',14,0,100,0,0,22057,'Cho\'Gall Wave Event');
