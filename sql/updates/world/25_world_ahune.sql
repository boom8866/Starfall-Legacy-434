...
UPDATE `creature_template` SET `minlevel`=85, `maxlevel`=85, `exp`=3, `faction_A`=14, `faction_H`=14 WHERE `entry` IN (25755,25756,25757);
UPDATE `creature_template` SET `mechanic_immune_mask`=650854239 WHERE `entry` IN (25740,25865, 26338,26339);
...
-- Cloaks
('28682','69770','0','1','1','1','1'),
('28682','69766','0','1','1','1','1'),
('28682','69767','0','1','1','1','1'),
('28682','69768','0','1','1','1','1'),
('28682','69769','0','1','1','1','1'),
-- Shards of Ahune
...
(25740, 0, 0, 0, 395, 70), -- 5 players
(26338, 0, 0, 0, 395, 70); -- 5 players

DELETE FROM conditions WHERE SourceEntry IN (46363);
