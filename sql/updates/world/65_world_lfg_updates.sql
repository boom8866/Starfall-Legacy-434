UPDATE `quest_template` SET `RewardCurrencyCount1`= 150 WHERE `id` IN (28905, 28906, 28907, 28908, 29185, 29183);
UPDATE `quest_template` SET `RewardCurrencyCount1`= 250 WHERE `id` IN (30110, 30111);
