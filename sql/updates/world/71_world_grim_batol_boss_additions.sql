-- General Husam
UPDATE `creature_template` SET `rank`= 3, `mindmg`= 532, `maxdmg`= 798, `attackpower`= 199, `dmg_multiplier`= 20, `flags_extra`= 1 WHERE `entry`= 39625;
UPDATE `creature_template` SET `rank`= 3, `mindmg`= 532, `maxdmg`= 798, `attackpower`= 199, `dmg_multiplier`= 35, `flags_extra`= 1 WHERE `entry`= 48337;

-- Forgemaster Throngus
UPDATE `creature_template` SET `rank`= 3, `mindmg`= 532, `maxdmg`= 798, `attackpower`= 199, `dmg_multiplier`= 20, `flags_extra`= 1, `mingold`= 19500, `maxgold`= 20000 WHERE `entry`= 40177;
UPDATE `creature_template` SET `rank`= 3, `mindmg`= 532, `maxdmg`= 798, `attackpower`= 199, `dmg_multiplier`= 35, `flags_extra`= 1, `mingold`= 19500, `maxgold`= 20000 WHERE `entry`= 48702;
