...
UPDATE `creature_template` SET `ScriptName`='npc_alpha_beam', `modelid1`= 1126, `modelid2`= 11686 WHERE `entry`=41144;
UPDATE `creature_template` SET `ScriptName`='npc_omega_stance', `modelid1`= 1126, `modelid2`= 11686, `InhabitType`= 4 WHERE `entry`=41194;

DELETE FROM `spell_script_names` WHERE `spell_id`=94974;

DELETE FROM `gossip_menu_option` WHERE `menu_id`= 12512;
REPLACE INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_id`, `npc_option_npcflag`) VALUES
(12512, 0, 1, 'We\'re ready! Go, Brann!', 1, 1);
...
(41144, 0, 0x0, 0x1, '91205'); -- Alpha Beam
