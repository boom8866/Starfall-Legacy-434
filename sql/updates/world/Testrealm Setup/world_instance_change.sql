-- Phasemask update for Asaad (id: 43875) in zone: 5035, area: 5035
UPDATE `creature` SET `phasemask` = 2 WHERE `guid` = 778231;
...
-- Phasemask update for High Priestess Azil (id: 42333) in zone: 5088, area: 5088
UPDATE `creature` SET `phasemask` = 2 WHERE `guid` = 222289;
