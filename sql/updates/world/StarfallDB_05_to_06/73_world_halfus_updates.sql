...
UPDATE `creature_template` SET `minlevel`= 87, `maxlevel`= 87, `IconName`= 'Interact', `faction_A`= 35, `faction_H`= 35, `exp`= 3, `AIName`= '', `mechanic_immune_mask`= 667893759 WHERE `entry` IN (44650, 46218, 46219, 46220, 44652, 46215, 46216, 46217, 44641, 46224, 46225, 46226, 44645, 46212, 46213, 46214, 44797, 46221, 46222, 46223);
...
UPDATE `creature_template` SET `minlevel`= 87, `maxlevel`= 87, `faction_A`= 16, `faction_H`= 16, `exp`= 3, `InhabitType`= 4, `mechanic_immune_mask`= 667893759, `movementId`= 150 WHERE `entry` IN (44687, 46227, 46228, 46229);
