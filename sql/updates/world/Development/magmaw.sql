...
UPDATE `creature_template` SET `modelid1`= 11686, `modelid2`= 0, `modelid3`= 0, `faction`= 1375, `unit_flags`= 33554496, `unit_class`= 4, `scriptname`= 'npc_bwd_magmaws_pincer' WHERE `entry` IN (41620, 41789); -- Pincer
UPDATE `creature_template` SET `scriptname`= 'npc_bwd_pillar_of_flame', `modelid1`= 1126, `modelid2`= 16925, `unit_flags`= 33587264, `minlevel`= 85, `maxlevel`= 85, `faction`= 14, `flags_extra`= 131 WHERE `entry`= 41843; -- Pillar of Flame
UPDATE `creature_template` SET `scriptname`= 'npc_bwd_lava_parasite', `minlevel`= 85, `maxlevel`= 85, `exp`= 3, `faction`= 14  WHERE `entry` IN (41806, 42321); -- Lava Parasites
UPDATE `creature_template` SET `minlevel`= 85, `maxlevel`= 85, `faction`= 190,  `modelid1`= 1126, `modelid2`= 16925, `unit_flags`= 33587264, `flags_extra`= 131 WHERE `entry`= 47196; -- Room Stalker (Crash Visual)
